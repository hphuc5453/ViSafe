...
class Bubble(
    ...
    override fun draw(canvas: Canvas) {
        if (mStrokeWidth > 0) {
            mStrokePath?.let { mStrokePaint?.let { it1 -> canvas.drawPath(it, it1) } }
        }
    ...
    private fun initLeftRoundedPath(
        ...
        path.lineTo(
            rect.left + mArrowWidth + mCornersRadius + strokeWidth,
        ...
        path.lineTo(
            ...
            mArrowHeight + mArrowPosition - strokeWidth / 2
        )
    ...
    private fun initTopRoundedPath(
        ...
        path.lineTo(
            rect.left + mArrowPosition + strokeWidth / 2,
            rect.top + mArrowHeight + strokeWidth
        )
        path.lineTo(
            rect.left + mArrowWidth / 2 + mArrowPosition,
            rect.top + strokeWidth + strokeWidth
        )
        path.lineTo(
        ...
        path.lineTo(
            rect.right - mCornersRadius - strokeWidth,
            rect.top + mArrowHeight + strokeWidth
        )
        path.arcTo(
            RectF(
    ...
    private fun initRightRoundedPath(
        ...
        path.lineTo(
            rect.width() - mCornersRadius - mArrowWidth - strokeWidth,
        ...
        path.lineTo(
            rect.right - mArrowWidth - strokeWidth,
            mArrowPosition + mArrowHeight - strokeWidth / 2
        )
        path.lineTo(
            rect.right - mArrowWidth - strokeWidth,
            rect.bottom - mCornersRadius - strokeWidth
        )
        path.arcTo(
            RectF(
    ...
    private fun initBottomRoundedPath(
        ...
        path.lineTo(
            rect.right - strokeWidth,
            rect.bottom - mArrowHeight - mCornersRadius - strokeWidth
        )
        path.arcTo(
            RectF(
        ...
        path.lineTo(
            rect.left + mArrowPosition + mArrowWidth / 2,
            rect.bottom - strokeWidth - strokeWidth
        )
        path.lineTo(
            rect.left + mArrowPosition + strokeWidth / 2,
            rect.bottom - mArrowHeight - strokeWidth
    ...
    private fun initBottomSquarePath(
        ...
        path.lineTo(
            rect.left + mArrowPosition + strokeWidth,
            rect.bottom - mArrowHeight - strokeWidth
        )
